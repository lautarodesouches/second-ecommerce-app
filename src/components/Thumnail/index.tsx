...
const Thumnail = ({ productId, imageNumber, handleSelectImage, numberMainImage }: { productId: number, imageNumber: number, handleSelectImage: any, numberMainImage: number }) => {
    return (
